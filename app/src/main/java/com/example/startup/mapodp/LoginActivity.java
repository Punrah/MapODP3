...
import com.example.startup.mapodp.app.AppController;
import com.example.startup.mapodp.helper.SessionManager;
import com.example.startup.mapodp.helper.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivity.this, MapOdpActivity.class);
